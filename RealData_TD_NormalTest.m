...
%% Load in Brainstorm and the atlas (do this first before anything else)

brainstorm

load("scout_Desikan-Killiany_68.mat")

%% Make all connecticity matrices 

%Participant 1 at timepoint 1

% Load in correct datasets
...
Data_par1_T1 = constrained_par1_T1' * F;
...
Data_par1_T35 = constrained_par1_T35' * F;
...
colormap("parula");
colorbar;
title('Connectivity Matrix Participant1 T35');
clim([-1,1]);
...
Data_par2_T1 = constrained_par2_T1' * F;
...
colormap("parula");
colorbar;
title('Connectivity Matrix Participant2 T1');
clim([-1,1]);
...
Data_par2_T35 = constrained_par2_T35' * F;
...
colormap("parula");
colorbar;
title('Connectivity Matrix Participant2 T35');
clim([-1,1]);
...
Data_par3_T1 = constrained_par3_T1' * F;
...
colormap("parula");
colorbar;
title('Connectivity Matrix Participant3 T1');
clim([-1,1]);
...
Data_par3_T35 = constrained_par3_T35' * F;
...
colormap("parula");
colorbar;
title('Connectivity Matrix Participant3 T35');
clim([-1,1]);
